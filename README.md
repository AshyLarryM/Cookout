...
Once logged in, users have access to view other users that have been authenticated, and recipes posted by the community of users.  Above the recipes there are multiple categories to filter the recipes based on the type of meal you are desiring.
